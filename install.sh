...
sudo docker run -itd --name=Gateone_Jail -p 2222:2222 -p 10000:10000 --restart=always gateone_jail
sudo docker exec Gateone_Jail service ssh restart
...
sudo docker exec FTP_Server service vsftpd restart
